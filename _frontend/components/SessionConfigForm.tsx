...
// // Mocked fetch function for the whitelist
// async function fetchWhitelist(): Promise<string[]> {
//   return ['All', 'medium.com', 'geeksforgeeks.org']
// }
...
// export function SessionConfigForm({ onChange }: Props) {
...
//     }
//   }, [nRetrieve, nRerank, selectedWhitelist])

//   const toggleWhitelistItem = (domain: string) => {
